...
//   //only display business that have spent more than $9,000
//   const bigSpenders = businesses.filter(business => {
//     const orderSum = business.orders.reduce((sum, currentAmount)=> {
...
//     return planet.charAt(0).toUpperCase() + planet.substring(1);
// })
